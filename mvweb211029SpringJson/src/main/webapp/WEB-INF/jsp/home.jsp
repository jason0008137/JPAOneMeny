...
<fieldset>
	...
	Supplier ID :
	<input type="text" id="supId" value="1" /><br />

	Supplier Name :
	<input type="text" id="supName" value="Gjun Coffee Inc.," /><br /> 

	Street :
	<input type="text" id="street" value="Kung Yuan 30" /><br />

	City :
	<input type="text" id="city" value="Taipei" /><br />

	zip :
	<input type="text" id="zip" value="100" /><br />

	state :
	<input type="text" id="state" value="TW" /><br />
...
<p>
	<fieldset>
		...
		Coffee Name :
		<input type="text" id="cofName" value="Gjun Gold Brand" /><br />

		Sale :
		<input type="text" id="sales" value="300" /><br />

		total :
		<input type="text" id="total" value="99" /><br />

		price :
		<input type="text" id="price" value="250" /><br />
